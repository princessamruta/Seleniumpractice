package propertyData;
	...
	public class ReadPropertyFile 
	{
		...
		{
			//Absolute path --> "D:\\class software\\Eclipse\\SeleniumBasic\\src\\PropertyFile\\SignUpDetails.properties"
			...
			// Absolute path
			FileInputStream fis = new FileInputStream("D:\\class software\\Eclipse\\SeleniumBasic\\src\\PropertyFile\\SignUpDetails.properties");
							// or
			//FileInputStream fis1 = new FileInputStream(filePath);
			// or relative path
		//	FileInputStream fis2 = new FileInputStream(".PropertyFile\\SignUpDetails.properties");
